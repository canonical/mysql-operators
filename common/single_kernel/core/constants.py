...
PASSWORD_BACKUPS_KEY = "backups-password"
PASSWORD_MONITOR_KEY = "monitoring-password"
PASSWORD_OPERATOR_KEY = "operator-password"
PASSWORD_REPLICATION_KEY = "replication-password"
