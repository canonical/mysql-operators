...
class VMServerService(BaseServerService):
    ...
    def running(self) -> bool:
        ...
        service = snap.services[self.name]
    ...
    def initialized(self) -> bool:
        ...
        # fmt: off
        data_files = self._system.shell.execute_sync([
            f"find",
    ...
    def install(self, revision: str | None = None) -> None:
        ...
        if revision is None:
            ...
            revision = version_data["snap"]["revisions"][platform.machine()]
        ...
        try:
            ...
            logger.error(f"Failed to install snap {self.snap_name}: {e}")
            raise
