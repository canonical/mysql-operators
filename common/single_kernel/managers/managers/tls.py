...
class TLSManager:
    ...
    def __init__(self, state: TLSState, system: BaseSystem, clients: Clients):
    ...
    def enable(self, ca_path: str, cert_path: str, key_path: str) -> None:
        ...
        try:
            ...
            raise RuntimeError("Failed to enable TLS") from e
    ...
    def disable(self) -> None:
        ...
        try:
            ...
            raise RuntimeError("Failed to disable TLS") from e
