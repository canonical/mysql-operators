...
class TLSManager:
    ...
    def __init__(self, state: TLSState, system: BaseSystem, clients: ManagerClients):
    ...
    def check_instance(self) -> None:
        ...
        if state != InstanceState.ONLINE:
            raise RuntimeError(f"Instance is not healthy")
    ...
    def enable(self, ca_path: str, cert_path: str, key_path: str) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to enable TLS: {e}")
    ...
    def disable(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to disable TLS: {e}")
    ...
    def parse_private_key(self, secret_id: str | None) -> PrivateKey | None:
        ...
        try:
            secret_content = self._state.secrets.get_secret_content(secret_id)
