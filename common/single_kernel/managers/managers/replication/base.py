...
class BaseReplicationManager(ABC):
    ...
    def get_ready_flag(self) -> bool | None:
        ...
        return self._state_local.get_replication_ready_flag()

    def set_ready_flag(self, flag: bool) -> None:
        """Set the replication ready flag."""
        return self._state_local.set_replication_ready_flag(flag)

    def delete_ready_flag(self) -> None:
        """Delete the replication ready flag."""
        return self._state_local.delete_replication_ready_flag()
