...
class RollingManager:
    ...
    def prepare_cluster(self, instance_host: str) -> None:
        """Prepare the MySQL cluster for a rolling operation."""
        try:
            self._clients.cluster.promote_instance(instance_host, force=False)
        except ExecutionError as e:
            raise RuntimeError("Failed to prepare cluster") from e
    ...
    def recover_cluster(self) -> None:
        ...
        try:
            ...
            raise RuntimeError("Failed to recover cluster") from e
    ...
    def recover_instance(self, instance_label: str) -> None:
        ...
        try:
            ...
            raise RuntimeError("Failed to recover instance") from e
