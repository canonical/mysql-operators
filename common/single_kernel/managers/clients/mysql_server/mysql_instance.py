...
class MySQLInstanceClient:
    ...
    def __init__(
        ...
        auth_builder: BaseAuthorizationQueryBuilder,
        logs_builder: BaseLoggingQueryBuilder,
    ):
        """Initialize the class attributes."""
        self._executor = executor
        self._client = InstanceClient(executor)
        self._auth_builder = auth_builder
        self._logs_builder = logs_builder
    ...
    def create_auth_roles(self) -> None:
        ...
        query = self._auth_builder.build_instance_auth_roles_query()
    ...
    def flush_native_logs(self, logs: Sequence[LogType]) -> None:
        ...
        query = self._logs_builder.build_logs_flushing_query(logs)
        _____ = self._executor.execute_sql(query)
