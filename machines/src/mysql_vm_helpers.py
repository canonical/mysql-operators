...
class MySQL(MySQLBase):
    ...
    def restore_backup(
        ...
        try:
            ...
            # Also change permissions for logs directory where undo files and binlogs go
            subprocess.run(  # noqa: S603
                ["/usr/bin/chmod", "770", MYSQL_LOGS_DIR],
                user=ROOT_SYSTEM_USER,
                group=ROOT_SYSTEM_USER,
                capture_output=True,
                text=True,
        ...
        try:
            ...
            # Revert permissions for the logs directory
            subprocess.run(  # noqa: S603
                ["/usr/bin/chmod", "750", MYSQL_LOGS_DIR],
                user=ROOT_SYSTEM_USER,
                group=ROOT_SYSTEM_USER,
                capture_output=True,
                text=True,
            ...
            # Also change ownership for the logs directory
            subprocess.run(  # noqa: S603
                [
                    "/usr/bin/chown",
                    "-R",
