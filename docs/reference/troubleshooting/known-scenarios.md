...
{ref}`Contact us <contacts>` if there is a scenario you'd like to suggest, or add yourself.

## Kubernetes charm

The troubleshooting scenarios below are only relevant to the MySQL charm on Kubernetes.
...
The troubleshooting scenarios below are only relevant to the MySQL charm on machines/VM.
