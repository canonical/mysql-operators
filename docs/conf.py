...
html_title = project +  " 8.0" + " documentation"
...
html_context = {
    ...
    "license": {
        ...
        "url": "https://github.com/canonical/mysql-operators/blob/8.0/edge/LICENSE",
    },
}
...
html_baseurl = f"https://canonical.com/data/mysql/docs/{version_slug}/"
