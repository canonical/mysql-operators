...
:sync: vm
    ...
    mysql                    8.0.32   active      1  mysql                    8.0/stable  144  no       Primary
...
:sync: k8s
    ...
    mysql-k8s                    8.0.32   active      1  mysql-k8s                    8.0/stable   61  10.152.183.115  no       Primary
    ...
    opentelemetry-collector-k8s/0*  active    idle   10.1.84.116         Primary
```
````
`````
