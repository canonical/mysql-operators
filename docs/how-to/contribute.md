...
* Report software issues or feature requests through [**GitHub**](https://github.com/canonical/mysql-operators/issues)
* Report security issues through [**Launchpad**](https://launchpad.net/)

## Contribute to the code

Before developing new features or fixes to this charm, you consider [opening an issue on GitHub](https://github.com/canonical/mysql-operators/issues) explaining your use case.
...
* Use the "Give feedback" button at the top of the page, or open an [issue](https://github.com/canonical/mysql-operators/issues) on GitHub directly.
