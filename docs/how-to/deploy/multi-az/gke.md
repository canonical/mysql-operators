...
This guide goes through an example deployment of MySQL K8s on GKE (Google Kubernetes Engine) with Juju zone constraints/anti-affinity rules.
...
Information about availability zones on specific clouds, and more about node selection on Kubernetes.
