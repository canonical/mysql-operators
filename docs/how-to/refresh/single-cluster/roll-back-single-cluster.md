...
To resume the refresh on the remaining units use the `resume-refresh` action:
...
This will rollback the pods in the remaining units to the same charm revision.
