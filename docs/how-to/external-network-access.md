...
* [MySQL Router for machines](https://github.com/canonical/mysql-router-operators/blob/dpe/kubernetes/docs/how-to/h-external-access.md)
* [MySQL Router for Kubernetes](https://github.com/canonical/mysql-router-operators/blob/dpe/machines/docs/how-to/h-external-access.md)
