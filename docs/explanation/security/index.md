...
* [MySQL Router for machines](https://github.com/canonical/mysql-router-operators/blob/dpe/kubernetes/docs/how-to/h-upgrade.md)
* [MySQL Router for Kubernetes](https://github.com/canonical/mysql-router-operators/blob/dpe/machines/docs/how-to/h-upgrade.md)
