...
class CharmConfig(BaseConfigModel):
    ...
    mysql_interface_user: str | None = Field(default=None)
    mysql_interface_database: str | None = Field(default=None)
    mysql_root_interface_user: str | None = Field(default=None)
    mysql_root_interface_database: str | None = Field(default=None)
    ...
    @classmethod
    def user_name_validator(cls, value: str) -> str | None:
    ...
    @field_validator("mysql_interface_database", "mysql_root_interface_database")
    @classmethod
    def database_name_validator(cls, value: str) -> str | None:
