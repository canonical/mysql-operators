...
class TestSelfHealingManager(unittest.TestCase):
    ...
    def test_start_skips_when_process_running(self, _popen, _kill):
        ...
        self.charm.unit_peer_data["self-healing-manager-pid"] = "12345"
    ...
    def test_start_restarts_when_process_dead(self, _popen, _kill):
        ...
        self.assertEqual(self.charm.unit_peer_data["self-healing-manager-pid"], "4242")
    ...
    def test_start_launches_new_process(self, _popen):
        ...
        self.assertEqual(args[0][1], "scripts/self_healing_dispatcher.py")
        self.assertEqual(args[0][2], self.charm.unit.name)
        self.assertEqual(kwargs["env"].get("JUJU_CONTEXT_ID"), None)
        self.assertEqual(self.charm.unit_peer_data["self-healing-manager-pid"], "99")

    # ------------------------------------------------------------------
    # stop_self_healing_manager
    # ------------------------------------------------------------------
    ...
    def test_stop_kills_and_clears_pid(self, _kill):
        ...
        self.assertNotIn("self-healing-manager-pid", self.charm.unit_peer_data)
