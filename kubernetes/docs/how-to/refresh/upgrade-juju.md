...
juju bootstrap microk8s k8s_3.6.13 # --agent-version 3.6.13

juju migrate k8s_3.5.3:mydatabase k8s_3.6.13

juju upgrade-model -m k8s_3.6.13:mydatabase 
# wait until complete
```
...
```shell
~$ juju bootstrap microk8s k8s_3.6.13 # --agent-version 3.6.12

Creating Juju controller "k8s_3.6.13" on microk8s/localhost
...
Bootstrap complete, controller "k8s_3.6.13" is now available
...
k8s_3.6.13  -           admin  superuser  microk8s/localhost       1      1  none  3.6.13
...
~$ juju models -c k8s_3.6.13
Controller: k8s_3.6.13
Model       Cloud/Region        Type      Status     Machines  Units  Access  Last connection
controller  microk8s/localhost  microk8s  available         1      1  admin   just now
...
```shell
> juju status -m k8s_3.6.13:mydatabase
Model       Controller  Cloud/Region        Version  SLA          Timestamp
mydatabase  k8s_3.6.13  microk8s/localhost  3.5.3    unsupported  22:58:10+02:00
...
...
> juju status -m k8s_3.6.13:mydatabase
Model       Controller  Cloud/Region        Version  SLA          Timestamp
mydatabase  k8s_3.6.13  microk8s/localhost  3.6.13    unsupported  22:59:01+02:00
...
```
</details>
